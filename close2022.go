			...
			programBranch.Child(format.Instruction("Close2022")).
				...
				ParentFunc(func(instructionBranch treeout.Branches) {
					...
					instructionBranch.Child("Accounts").ParentFunc(func(accountsBranch treeout.Branches) {
						accountsBranch.Child(format.Meta("    account", inst.Accounts[0]))
						accountsBranch.Child(format.Meta("destination", inst.Accounts[1]))
						accountsBranch.Child(format.Meta("      owner", inst.Accounts[2]))
